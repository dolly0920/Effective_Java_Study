...
public class CustomObjectStreamConstants {
    ...
    private CustomObjectStreamConstants() {}

    public static short STREAM_MAGIC = -21267;
    ...
    public static final SerializablePermission SERIAL_FILTER_PERMISSION = new SerializablePermission("serialFilter");
